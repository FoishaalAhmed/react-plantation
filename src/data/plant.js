export const initialState = [
	{
		Id: 1,
		itemName: "Indore succulents",
		type: "Indore",
		price: 2200,
		itemImage: "Indore/3.jpg",
		description:"Indore succulents is a significant indoor tree. It is one of the few houseplants that prefers to be in the shade and develops its distinctive branches over which attractive leaves grow from bottom to top. so this indoor tree is also suitable for small spaces. ",
	},
	{
		Id: 2,
